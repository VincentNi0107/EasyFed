...
def partition_data(dataset, datadir, logdir, partition, n_parties, beta=0.4):
    ...
    elif (partition=='noniid-3-2' or partition=='noniid-3-5' or partition=='noniid-3-3' or partition=='noniid-3-8') and dataset=='cifar10':
...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None, noise_level=0):
    if dataset in ('cifar10', 'cifar100'):
        ...
        if train_bs==200:
            train_dl = data.DataLoader(dataset=train_ds, batch_size=train_bs, drop_last=False, shuffle=False)
        else:
